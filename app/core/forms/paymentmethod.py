...
class PaymentMethodForm(ModelForm):
  image = forms.ImageField(required=False, label="Método logo", widget=FileInput(attrs={
  ...
  class Meta:
    ...
    error_messages = {
      "description": {
        "unique": "Ya existe un método con este nombre.",
      },
    }
    widgets = {
      "description": forms.TextInput(
        attrs={
          "placeholder": "Ingrese descripción del método",
          "id": "id_description",

...
class CompanyForm(ModelForm):
    class Meta:
        model = Company
        fields = ['dni', 'name', 'address','representative','landline','website','email','logo','establishment_code','emission_point_code','authorization_number','taxpayer_type','required_to_keep_accounting','economic_activity_code']
        error_messages = {
            "name": {
                "unique": "Ya existe una compañía con este nombre"
            },
            'dni':{
                'unique': 'RUC ya registrado'
            }
        }
        widgets = {
            "dni": forms.TextInput(
            ...
            "landline": forms.TextInput(
                attrs={
                    "placeholder": "Ingrese el teléfono fijo de la compañía",
                    "class": "shadow-sm bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-12 dark:bg-principal dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light",
                }
            ),
            "website": forms.URLInput(
                attrs={
                    "placeholder": "Ingrese el sitio web de la compañia",
                    "class": "shadow-sm bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-12 dark:bg-principal dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light",
                }
            ),
            "email": forms.EmailInput(
                attrs={
                    "placeholder": "Ingrese el email de la compañia",
                    "class": "shadow-sm bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-12 dark:bg-principal dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light",
                }
            ),
            ...
            "establishment_code": forms.TextInput(
                attrs={
                    "placeholder": "Ingrese código de establecimiento de la compañia",
                    "class": "shadow-sm bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-12 dark:bg-principal dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light",
                }
            ),
            "emission_point_code": forms.TextInput(
                attrs={
                    "placeholder": "Ingrese código punto de emisión de la compañia",
                    "class": "shadow-sm bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-12 dark:bg-principal dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light",
                }
            ),
